...
/*   Updated: 2024/09/24 10:53:07 by plashkar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Counts the number of lines in the .cub file.
 *
...
/**
 * @brief Reads the .cub file and stores it in an array of strings.
 *
 * It will try to open the file and read it line by line.
 * If it fails to open the file, it will print an error message and exit.
 * @param argv The arguments passed to the program.
